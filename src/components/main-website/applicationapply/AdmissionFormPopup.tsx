...
function AdmissionFormPopup({ collegeName, collegeCategory }: any) {
    ...
    async function submitHandler(e: any) {
        ...
        const payload = {
            ...
            category: path.includes("engineering") ? "eng-Admission" : path.includes("management") ? "mang-Admission" : "med-Admission",
            college: collegeName,
            ...
            <div style={customStyle} className="main-popup w-full lg:w-4/6 bg-[#f7f7f7] p-2 pb-5 rounded-lg">
                <div className="popup-header max-h-[60px] lg:max-h-full mt-5 flex">
                    ...
                    <div className="pop-header-center w-[75%] flex flex-col justify-center items-center lg:items-start">
                        <h1 className="text-primaryBtn text-lg lg:text-3xl font-semibold">Register for Admission</h1>
